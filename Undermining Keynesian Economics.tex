...
modern international and globalized economies. The upshot of this
...
then (1-c+m) then the multiplier may even be negative. Public
...
Keynesian demand mangement is an idea that continues to fall apart
like an ancient ruin. This happens not because of a negligence from
the side of conserving archeologists, quite to the contrary, it
...
extendet to open economies. In textbooks, The Haavelmo theorem
...
in open economy models is grossly erronenous on theoretical grounds.
By combinging the two results it may be shown that the Keynesian
...
taxes, public debt or by additonal money. Restrictions of the
...
soon as the import content paramter $\alpha$ is larger than $c-m$
the multiplier will be smaller than 1. It even converges to zero as
the import content parameter of additonal public demand approaches
1.
...
unpleasent surprises in cases where the parameter is neglected,
...
Nikolaus K.A. Läufer, Neglecting the import content of shifts in
